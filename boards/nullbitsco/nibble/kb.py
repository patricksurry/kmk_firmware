...
from kmk.scanners.keypad import DemuxMatrixScanner
...
class KMKKeyboard(_KMKKeyboard):
    ...
    def __init__(self, encoder=False):
        ...
        # The nibble multiplexes on columns so transpose=True
        # It uses an inverting demux '138 IC so columns_to_anodes=True
        self.matrix = DemuxMatrixScanner(
            row_addr_pins=col_mux_pins,
